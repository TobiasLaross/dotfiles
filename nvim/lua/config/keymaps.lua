...
vim.keymap.set("n", "<leader>rs", cmd.smart_replace, { noremap = true, silent = true })
vim.keymap.set("n", "<leader>rw", cmd.smart_replace_word, { noremap = true, silent = true })
vim.keymap.set("v", "<leader>rv", cmd.smart_replace_visual, { noremap = true, silent = true })
