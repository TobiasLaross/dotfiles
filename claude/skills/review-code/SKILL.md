...
"You are reviewing whether the following implementation aligns with the established design patterns in this codebase. You have access to the filesystem.\n\n1. Read the project structure to identify where similar features live.\n2. Use Glob and Grep to find 2-4 existing features that are similar in nature to what was implemented.\n3. Read those files to understand the established patterns: naming conventions, layer separation, error handling, data flow, dependency injection, etc.\n4. Compare the new implementation against those patterns and flag any deviations.\n\nUse severity flags CRITICAL / HIGH / LOW. CRITICAL means the deviation would make this feature feel foreign to the codebase and create long-term inconsistency.\n\nBase branch: [BASE_BRANCH]\nTech stack: [TECH_STACK]\nProject structure: [PROJECT_STRUCTURE]\nNew files reviewed: [FILE_PATHS]\n\n[CODE]"
